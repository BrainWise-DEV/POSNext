...
function addDuplicateBanner(html, isDuplicate = false) {
	...
	const source = html || "";
	// Receipt formats using .receipt-type place it immediately after the company
	// identity block. Insert DUPLICATE there so the header stays visually grouped
	// with the reprint marker. Other/custom formats fall back to prepending it.
